...
export const MarketBar = ({market}: {market: string}) => {
    ...
    useEffect(() => {
        ...
        // first make an http request to get the ticker data
        getTicker(market).then(setTicker);

        // then setup a WS connection to get the live ticker data
        ...
        // when I change the route or component unmounts, I want to unsubscribe from the ticker channel
        return () => {
